...
// ─── Screen 1: Debit Note List ────────────────────────────────────────────────
function DebitNoteList({ onCreateClick }) {
  return (
    <div className="dn-main">
      ...
      <div className="dn-toolbar">
        ...
        <button className="dn-btn-primary" onClick={onCreateClick}>Create Debit Note</button>
      </div>
...
// ─── Screen 2: Create Debit Note Form ────────────────────────────────────────
function CreateDebitNote({ onBack }) {
  ...
  return (
    <div className="dn-main dn-form-page">
      ...
      <div className="dn-form-header">
        <button className="dn-back-btn" onClick={onBack}><ArrowLeftIcon /></button>
        ...
        <div className="dn-form-header-actions">
          ...
          <button className="dn-btn-settings"><GearIcon /> Settings</button>
      ...
      <div className="dn-form-body">
        ...
        <div className="dn-left-col">
          ...
          <div className="dn-add-party-box">
            + Add Party
          </div>
...
export default function DebitNotePage() {
  ...
  return (
    <div className="dn-shell">
      <Sidebar />
      {view === "list"
        ? <DebitNoteList onCreateClick={() => setView("form")} />
        : <CreateDebitNote onBack={() => setView("list")} />
      }
    </div>
  );
}