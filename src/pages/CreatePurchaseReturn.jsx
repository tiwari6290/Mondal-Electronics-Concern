    ...
    <div className="pr-shell">
      ...
      <div className="pr-main pr-form-page">
        ...
        <div className="pr-form-header">
          <button className="pr-back-btn" onClick={() => navigate("/purchase-return")}>
            <ArrowLeftIcon />
          </button>
        ...
        <div className="pr-form-body">
          ...
          <div className="pr-left-col">
            ...
            <div className="pr-items-table">
              ...
              <div className="pr-add-item-row">+ Add Item</div>
            </div>
          ...
          <div className="pr-right-col">
            ...
            <div className="pr-search-invoice">
              <SearchIcon />
              <input className="pr-search-input" placeholder="Search purchase invoices" />
            </div>
